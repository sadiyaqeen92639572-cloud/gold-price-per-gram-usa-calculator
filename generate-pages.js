...
const CASH_PAGE = {
  ...
  faq: [
    ...
    { q: 'Is this a pawn shop gold calculator?', a: 'Yes — this calculator estimates what a pawn shop or gold buyer would pay, applying an adjustable discount off the live spot price by karat. It\'s not any specific pawn shop\'s actual offer, since every buyer sets their own margin.' },
  ],
};
...
const SCRAP_PAGE = {
  ...
  faq: [
    ...
    { q: 'How do you calculate scrap gold value?', a: 'Melt value = weight in grams × the live price per gram for that karat — this is what people often mean by a "gold melt value calculator." For a mixed lot, each piece is calculated at its own karat and then added together — that\'s exactly what the multi-item calculator above does, rather than assuming one karat for the whole lot.' },
